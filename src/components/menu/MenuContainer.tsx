...
function MenuContainer() {
    ...
    return (
        <div className="min-w-[4.3rem] absolute min-[500px]:relative min-[500px]:flex bottom-0 flex-col justify-between max-[499px]:p-1 p-3 
                        max-[499px]:border-t max-[499px]:border-gray-700 sm:w-[70px] xl:w-[260px] max-[499px]:items-center
                        md:ml-4 md:mr-4 min-[500px]:w-[60px] min-[500px]:h-[100vh] bg-black z-50 max-[499px]:w-full">
            <div className="flex min-[500px]:flex-col justify-between pt-2 max-[499px]:pt-0">
                <svg className=" h-6 w-6 ml-3 mb-3 max-[499px]:absolute max-[499px]:-top-[89.5vh] max-[499px]:w-full 
            ...
            <MiniProfileCard userId={1} type="menu" ></MiniProfileCard>
        </div>
    )
}
